...
# Definir a arquitetura da rede neural (Q-Network)
...
# Criar as redes Q (online e target)
...
# Loop de treinamento
num_episodes = 5000  # Aumentei o número de episódios
...
for episode in range(num_episodes):
    ...
    if mean_reward >= target_score and episode > 100:  # Esperar um pouco antes de considerar resolvido
